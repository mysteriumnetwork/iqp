...
func (_ERC721Enumerable *ERC721EnumerableTransactor) Initialize(opts *bind.TransactOpts, name_ string, symbol_ string) (*types.Transaction, error) {
	return _ERC721Enumerable.contract.Transact(opts, "initialize", name_, symbol_)
}

// Initialize is a paid mutator transaction binding the contract method 0x4cd88b76.
//
// Solidity: function initialize(string name_, string symbol_) returns()
func (_ERC721Enumerable *ERC721EnumerableSession) Initialize(name_ string, symbol_ string) (*types.Transaction, error) {
	return _ERC721Enumerable.Contract.Initialize(&_ERC721Enumerable.TransactOpts, name_, symbol_)
}

// Initialize is a paid mutator transaction binding the contract method 0x4cd88b76.
//
// Solidity: function initialize(string name_, string symbol_) returns()
func (_ERC721Enumerable *ERC721EnumerableTransactorSession) Initialize(name_ string, symbol_ string) (*types.Transaction, error) {
	return _ERC721Enumerable.Contract.Initialize(&_ERC721Enumerable.TransactOpts, name_, symbol_)
}
